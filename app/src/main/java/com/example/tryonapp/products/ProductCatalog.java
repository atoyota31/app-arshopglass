package com.example.tryonapp.products;
...
import com.example.tryonapp.product_view.ProductView;
import com.example.tryonapp.about_us.AboutUsActivity;
import com.example.tryonapp.contact_us.ContactUsActivity;
...
public class ProductCatalog extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener, View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.card_1) {
            ...
            intent.putExtra("IMAGE", R.drawable.clubmaster_brun);
            startActivity(intent);
            ...
            intent.putExtra("IMAGE", R.drawable.glasogon_fyrkantiga);
            startActivity(intent);
            ...
            intent.putExtra("IMAGE", R.drawable.runda_glasogon);
            startActivity(intent);
            ...
            intent.putExtra("IMAGE", R.drawable.sport_solglasogon);
            startActivity(intent);
