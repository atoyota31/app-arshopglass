package com.example.tryonapp.product_view;
...
import com.example.tryonapp.form.FormOrder;
import com.example.tryonapp.products.ProductCatalog;
import com.example.tryonapp.product_details.ProductDetails;
import com.example.tryonapp.cart.CartActivity;
import com.example.tryonapp.ar_glass.GlassesActivity;
import com.example.tryonapp.product.service.ProductList;
...
public class ProductView extends AppCompatActivity {
    ...
    public void Try(View v){
        ...
        Toast.makeText(ProductView.this, "AR GLASSES", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(ProductView.this, GlassesActivity.class);
        startActivity(intent);

//        if (product_label.equals("MAGIC PINK LIP GLOSS")){
//            intent = new Intent(this, GlassesActivity.class);
//            intent.putExtra("LABEL", "MAGIC PINK LIP GLOSS");
